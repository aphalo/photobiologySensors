...
#' @keywords datasets
#'
#' @name Solar_Light_501_high_UVA.spct
#' @title Solar Light UVB biometer model 501 (unit with high UV-A sensitivity)
#' @note
#' Manufacturer: Solar Light Company, Glenside, PA, U.S.A.
#' Data kindly made available by Lasse Ylianttila. This is the response from a unit with a higher response to
#' UVA radiation than typical units, as observed in an intrument intercomparison.
#'
#' @references
