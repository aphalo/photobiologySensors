...
#' callibration. In other words, the data provided here are not a substitute
...
#' names(sensors.mspct)
#' 
#' q_ratio(sensors.mspct$LI_190_PAR_quantum, Blue(), Red())
#' 
#' plot(sensors.mspct$LI_190_PAR_quantum, unit.out = "photon")
#' 
"_PACKAGE"
