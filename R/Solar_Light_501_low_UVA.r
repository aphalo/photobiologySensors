...
#' @title Solar Light UVB biometer model 501 (unit with low UV-A sensitivity)
#' @note
#' UVB Biometer model 501 radiometer
#' Manufacturer: Solar Light Company, Glenside, PA, U.S.A.
#' Data kindly made available by Lasse Ylianttila. This is the response from a unit with a lower response to
