...
library(knitr)
opts_chunk$set(fig.path='figure/pos-', fig.align='center', fig.show='hold', size="footnotesize",            fig.width=10, fig.height=6, out.width='.95\\textwidth', warning=FALSE)
@
...
plotter <-
  function(spct,
           annotations = c("boxes", "labels", "summaries", "colour.guide"),
