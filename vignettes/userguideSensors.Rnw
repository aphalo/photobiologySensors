...
library(knitr)
opts_chunk$set(fig.path='figure/pos-', fig.align='center', fig.show='hold', size="footnotesize",            fig.width=8, fig.height=4, out.width='.47\\textwidth', dev='cairo_pdf')
@
...
sun.BW20.response <- 
  with(sun.spct, 
       sensor_response(w.length, s.e.irrad, "Vital_BW_20"))
@

The effective UV energy irradiance according to CIE erythemal action spectrum for this solar spectrum is \Sexpr{signif(sun.known.irrad, 4)} \watt and the BW-20 sensor response is \Sexpr{signif(sun.BW20.response, 4)}. 
...
tl12.known.irrad <- 
  with(philips.tl12.bentham.spct, 
       energy_irradiance(w.length, s.e.irrad, CIE()))
tl12.BW20.response <- 
  with(philips.tl12.bentham.spct, 
       sensor_response(w.length, s.e.irrad, "Vital_BW_20"))
...
The effective UV energy irradiance according to CIE erythemal action spectrum for this emission spectrum for a Philips 40W/TL12 UV-B lamp (not filtered) is \Sexpr{signif(tl12.known.irrad, 4)} \watt and the BW-20 sensor response is \Sexpr{signif(tl12.BW20.response, 4)}.
...
sun.BW20.calibration.factor <- 
  with(sun.spct, 
       sensor_response(w.length, s.e.irrad, 
                       "Vital_BW_20", 
                       reference.irrad=sun.known.irrad))
@

<<calc-calibration-factor-tl12>>=
tl12.BW20.calibration.factor <- 
  with(philips.tl12.bentham.spct, 
       sensor_response(w.length, s.e.irrad, 
                       "Vital_BW_20", 
                       reference.irrad=tl12.known.irrad))
@

The BW-20 calibration factor for solar radiation is \Sexpr{signif(sun.BW20.calibration.factor, 4)} while that for an unfiltered Philips 40W/TL12 UV-B lamps is \Sexpr{signif(tl12.BW20.calibration.factor, 4)}. In other words measurements of TL12 lamps with the BW-20 sensor calibrated for sunlight are \Sexpr{signif(sun.BW20.calibration.factor/tl12.BW20.calibration.factor * 100, 3)} \% of the true value.
...
acetate.s.e.irrad <-  
  with(philips.tl12.bentham.spct, 
       s.e.irrad * 
         calc_filter_multipliers(w.length, "acetate.115um.new"))
tl12.act.known.irrad <- 
  with(philips.tl12.bentham.spct, 
       energy_irradiance(w.length, acetate.s.e.irrad, CIE()))
tl12.act.BW20.calibration.factor <- 
  with(philips.tl12.bentham.spct, 
       sensor_response(w.length, acetate.s.e.irrad, 
                       "Vital_BW_20", 
                       reference.irrad=tl12.act.known.irrad))
@
...
The BW-20 calibration factor for solar radiation is \Sexpr{signif(sun.E1c.calibration.factor, 4)} while that for an unfiltered Philips 40W/TL12 UV-B lamps is \Sexpr{signif(tl12.E1c.calibration.factor, 4)}. In other words measurements of TL12 lamps with the E1c sensor calibrated for sunlight are \Sexpr{signif(sun.E1c.calibration.factor/tl12.E1c.calibration.factor * 100, 3)} \% of the true value.
...
tl12.act.known.irrad <- 
  with(philips.tl12.bentham.spct, 
       energy_irradiance(w.length, acetate.s.e.irrad, CIE()))
tl12.act.E1c.calibration.factor <- 
  with(philips.tl12.bentham.spct, 
       sensor_response(w.length, acetate.s.e.irrad, 
                       "Thies_E1c", 
                       reference.irrad=tl12.act.known.irrad))
...
In this case, measurements of a diacetate-filtered TL12 lamp with the E1c sensor calibrated for sunlight are \Sexpr{signif(sun.E1c.calibration.factor/tl12.act.E1c.calibration.factor * 100, 3)} \% of the true value.

\subsection{Solar Light 501}

We will now estimate the error involved in the use of a Thies Clima E1c sensor calibrated for sunlight, to measure Q-Panel UVB-313 lamps.

<<calc-calibration-factor-sun-SL501>>=
sun.SL501.calibration.factor <- 
  with(sun.spct, 
       sensor_response(w.length, s.e.irrad, 
                       "Solar_Light_501_typical", 
                       reference.irrad=sun.known.irrad))
@

<<calc-calibration-factor-tl12-SL501>>=
tl12.SL501.calibration.factor <- 
  with(philips.tl12.bentham.spct, 
       sensor_response(w.length, s.e.irrad, 
                       "Solar_Light_501_typical", 
                       reference.irrad=tl12.known.irrad))
...
The BW-20 calibration factor for solar radiation is \Sexpr{signif(sun.SL501.calibration.factor, 4)} while that for an unfiltered Philips 40W/TL12 UV-B lamps is \Sexpr{signif(tl12.SL501.calibration.factor, 4)}. In other words measurements of TL12 lamps with the SL501 sensor calibrated for sunlight are \Sexpr{signif(sun.SL501.calibration.factor/tl12.SL501.calibration.factor * 100, 3)} \% of the true value.

Now we check a more realistic example, a TL12 lamp filtered with cellulose diacetate. We still consider the same SL501 sensor calibrated for sunlight.

<<calc-calibration-factor-tl12-acetate-SL501>>=
acetate.s.e.irrad <-  
  with(philips.tl12.bentham.spct, 
       s.e.irrad * 
         calc_filter_multipliers(w.length, "acetate.115um.new"))
tl12.act.known.irrad <- 
  with(philips.tl12.bentham.spct, 
       energy_irradiance(w.length, acetate.s.e.irrad, CIE()))
tl12.act.SL501.calibration.factor <- 
  with(philips.tl12.bentham.spct, 
       sensor_response(w.length, acetate.s.e.irrad, 
                       "Solar_Light_501_typical", 
                       reference.irrad=tl12.act.known.irrad))
...
In this case, measurements of a diacetate-filtered TL12 lamp with the SL501 sensor calibrated for sunlight are \Sexpr{signif(sun.SL501.calibration.factor/tl12.act.SL501.calibration.factor * 100, 3)} \% of the true value.
