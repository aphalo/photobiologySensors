...
%\VignetteDepends{knitr, photobiology, photobiologySensors}
...
\title{\PBSen Version 0.1.3\\ User Guide}
...
sun.TOCONery.response <- with(sun.data, sensor_response(w.length, s.e.irrad, "TOCON_E2_erythemal"))
@
...
tl12.TOCONery.response <- with(philips.tl12.bentham.data, sensor_response(w.length, s.e.irrad, "TOCON_E2_erythemal"))
@
...
sun.BW20.calibration.factor <- with(sun.data, sensor_response(w.length, s.e.irrad, "Vital_BW_20", theoretical.response=sun.known.irrad))
sun.TOCONery.calibration.factor <- with(sun.data, sensor_response(w.length, s.e.irrad, "TOCON_E2_erythemal", theoretical.response=sun.known.irrad))
@

<<calc-calibration-factor-tl12>>=
tl12.BW20.calibration.factor <- with(philips.tl12.bentham.data, sensor_response(w.length, s.e.irrad, "Vital_BW_20", theoretical.response=tl12.known.irrad))
tl12.TOCONery.calibration.factor <- with(philips.tl12.bentham.data, sensor_response(w.length, s.e.irrad, "TOCON_E2_erythemal", theoretical.response=tl12.known.irrad))
@
...
tl12.act.BW20.calibration.factor <- with(philips.tl12.bentham.data, sensor_response(w.length, acetate.s.e.irrad, "Vital_BW_20", theoretical.response=tl12.act.known.irrad))
tl12.act.TOCONery.calibration.factor <- with(philips.tl12.bentham.data, sensor_response(w.length, acetate.s.e.irrad, "TOCON_E2_erythemal", theoretical.response=tl12.act.known.irrad))
@
