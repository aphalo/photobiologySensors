...
\begin{framed}
\noindent
This example will be expanded once package \PBS is updated to include the necessary solar spectral irradiance data. At the moment we do the calcualtions for a single solar elevation.
\end{framed}
